...
class DexterObjectDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        if data_split == 'test':
            ...
            self.logger.info("DexterObjectDataset here only for evaluation, no train set here !")
        ...
        if os.path.exists(cache_path) and use_cache:
            ...
            self.logger.info("DexterObjectDataset {} gt loaded from {}".format(self.data_split, cache_path))
            # print("DexterObjectDataset {} gt loaded from {}".format(self.data_split, cache_path))
            return

        self.logger.info("init DexterObjectDataset {}, It may take a while at first time".format(data_split))
        ...
        if use_cache:
            ...
            with open(cache_path, "wb") as fid:
                ...
                self.logger.info("Wrote cache for dataset DexterObjectDataset {} to {}".format(

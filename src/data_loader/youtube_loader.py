...
class YTB_DB(Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        img_width_ori = self.img_dict[self.joints_list[idx_]["image_id"]]["width"]
        img_height_ori = self.img_dict[self.joints_list[idx_]["image_id"]]["height"]
        img_width, img_height, _ = img.shape
        
        if img_width != img_width_ori or img_height != img_height_ori:
            img = cv2.resize(img, (img_width_ori, img_height_ori))
